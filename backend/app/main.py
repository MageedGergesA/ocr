...
<h2>مستنداتك لا تُخزَّن</h2>
<p>تُعالَج المستندات التي ترفعها في الذاكرة وتُحذَف فور انتهاء الاستخراج. لا نحتفظ بنسخ من ملفاتك ولا نؤرشفها.</p>
...
<h2>المدفوعات</h2>
<p>تُعالَج المدفوعات عبر مزوّد آمن (Stripe). لا نرى ولا نخزّن بيانات بطاقتك البنكية.</p>
